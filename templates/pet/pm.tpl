<div class="userinfo-menu">
		<ul class="userinfo-li">
			<li><a href="#" onClick="javascript: history.go(-1);" data-toggle="tab" style="color:red">ПРОФИЛЬ</a></li>
			<li><a href="#user2" data-toggle="tab">Редактировать</a></li>
			<li><a href="http://wikipet.by/index.php?do=pm&amp;doaction=newpm&amp;username=belvision2">написать ПС</a></li>
		</ul>
	</div>
