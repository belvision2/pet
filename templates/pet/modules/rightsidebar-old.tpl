...
[not-category=11,22,23,29,37,38,39,40,41,42,43,25,46,13,14,15,16,17,18,21,49,27,52,55,56,24,54,60-71]
...
<li class="dropdown" id="dropdown-show">
  ...
  <ul class="v-menu">
    ...
    <div class="clear"></div>
    <div class="esli hide-fullstory"><span>если вы решили<br />завести собаку</span></div>
   [banner_right-sidebar-1]{banner_right-sidebar-1}[/banner_right-sidebar-1]
   </div>
