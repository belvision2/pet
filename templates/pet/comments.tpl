<div class="comment" id="{comment-id}">
	<div class="com_info">
		...
		<div class="com_user">
		<div class="comments">
			<span class="name">{fullname}[not-fullname]Безымянный [/not-fullname]</span>
			<span class="date"> {date=d.m.Y}</span><br />
              [xfgiven_moi-zivotnie]Питомец :[xfvalue_moi-zivotnie][/xfgiven_moi-zivotnie]
			</div>
		</div>
		<div class="meta">
			[rating]
