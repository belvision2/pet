...
<div class="clear"></div>
<div class="empty">
    {custom category="20" order="reads" limit="1" from="0" template="index-collag1"}

<div class="col-2">
	{custom category="20" order="reads" limit="1" from="1" template="index-collag2"}
{custom category="42" order="reads" limit="1" from="0" idexclude="56" template="index-collag2"}
</div>
<div class="col-3">
{custom category="42" order="reads" limit="1" from="1" idexclude="56" template="index-collag3"}
{custom category="99" order="reads" limit="1" from="0" idexclude="56" template="index-collag3"}
{custom category="99" order="reads" limit="1" from="1" idexclude="56" template="index-collag4"}
</div></div>

	{custom category="20" order="reads" limit="6" from="0" idexclude="56" template="index-collag-positiv"}
