  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="newcatsLabel">{$lang['cat_add']}</h5>
      </div>
      <div class="modal-body">
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_name']}</label>
		  <div class="col-lg-9">
			<input style="width:100%;max-width:350px;" type="text" name="cat_name" required>&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_catname']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_url']}</label>
		  <div class="col-lg-9">
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_addicon']}</label>
		  <div class="col-lg-9">
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['meta_title']}</label>
		  <div class="col-lg-9">
			<input type="text" name="meta_title" style="width:100%;max-width:350px;"> ({$lang['meta_descr_max']})
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['meta_descr_cat']}</label>
		  <div class="col-lg-9">
			<input type="text" name="descr" style="width:100%;max-width:350px;"> ({$lang['meta_descr_max']})
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['meta_keys']}</label>
		  <div class="col-lg-9">
			<textarea name="keywords" style="width:100%;max-width:350px;" rows="5"></textarea>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_parent']}</label>
		  <div class="col-lg-9">
			<select class="uniform" name="category" >{$categorylist}</select>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_skin']}</label>
		  <div class="col-lg-9">
			{$skinlist}&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_cattempl']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['opt_sys_sort']}</label>
		  <div class="col-lg-9">
...
<option value="title">{$lang['opt_sys_salph']}</option>
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['opt_sys_msort']}</label>
		  <div class="col-lg-9">
...
<option value="ASC">{$lang['opt_sys_mplus']}</option>
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['opt_sys_sub']}</label>
		  <div class="col-lg-9">
...
<option value="2">{$lang['opt_sys_no']}</option>
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_allow_rss']}</label>
		  <div class="col-lg-9">
			<select class="uniform" name="allow_rss" style="min-width:100px;">
<option value="1" selected>{$lang['opt_sys_yes']}</option>
<option value="0">{$lang['opt_sys_no']}</option>
</select>
		  </div>
		 </div>	

		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['opt_sys_newc']}</label>
		  <div class="col-lg-9">
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_s_tpl']}</label>
		  <div class="col-lg-9">
		...
		<div class="form-group">
		  <label class="control-label col-lg-3">{$lang['cat_f_tpl']}</label>
		  <div class="col-lg-9">
      ...
      <div class="modal-footer">
	    <button type="submit" class="btn btn-green">{$lang['vote_new']}</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">{$lang['p_cancel']}</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="box-header">
	...
	<ul class="box-toolbar">
      <li class="toolbar-link">
          <a href="#" data-toggle="modal" data-target="#newcats"><i class="icon-plus"></i> {$lang['b_cats_1']}</a>
      </li>
    </ul>
  </div>
  <div class="box-content">
...
HTML;
	...
	<div class="box-footer padded">
		<button id="catsort" class="btn btn-blue">{$lang['cat_posi']}</button> <button class="btn btn-blue nestable-action" data-action="expand-all">{$lang['cat_expand']}</button> <button class="btn btn-blue nestable-action" data-action="collapse-all">{$lang['cat_collapse']}</button>
	</div>
  </div>
</div>
<script>
