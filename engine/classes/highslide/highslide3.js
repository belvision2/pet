...
undim : function(key) {
	...
	else hs.animate(hs.dimmer, { opacity: 1 }, hs.dimmingDuration, null, function() {
	...
	try {
		...
		for (var i = 0; i < exp.overlays.length; i++) (function() {
			...
			if (o && o.hideOnMouseOut) {
				...
				hs.animate(o, { opacity: over ? o.opacity : 1 }, o.dur);
			}
		})();	
	} catch (e) {}
},
...
focus : function() {
	...
	this.content.className = 'highslide-'+ this.contentType;
		...
		if (hs.restoreCursor) {
			hs.styleRestoreCursor = window.opera ? 'pointer' : 'zoom-out';
...
hs.addEventListener(document, 'ready', hs.setClickEvents);
 ...
 $(".highslide-image").after("<div class='es19__copyr'></div>");