...
-----------------------------------------------------
 http://dle-news.ru/
-----------------------------------------------------
 Copyright (c) 2009-2017 IT-Security (Asafov Sergey)
=====================================================
...
if(!class_exists('DLE_API'))
{
	...
	$dle_api = new DLE_API ();
	if( !$config['version_id'] ) { include_once (ENGINE_DIR . '/data/config.php'); date_default_timezone_set ( $config['date_adjust'] ); }
