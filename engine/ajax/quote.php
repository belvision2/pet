...
if($area == "admin") {
	echo "<textarea id='edit-comm-{$id}' style=\"width:100%;\" rows=\"15\">{$text}</textarea><br /><br /><a onclick=\"ajax_save_comm_edit('{$id}'); return false;\" href=\"#\" class=\"btn btn-xs btn-green\"><i class=\"icon-ok\"></i> <b>{$lang['bb_b_approve']}</b></a><br /><br />";
} else {
