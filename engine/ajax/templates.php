...
HTML;
	...
	echo <<<HTML
<br /><br /><div style="border: solid 1px #BBB;width:99%;height:460px;"><textarea style="width:100%;height:440px;" name="file_text" id="file_text" wrap="off">{$content}</textarea></div>
<div style="padding:5px;"><input onClick="savefile('{$file_path}/{$file_name}')" type="button" class="btn btn-green" value="{$lang['user_save']}" style="width:100px;"></div>
{$script}
HTML;
