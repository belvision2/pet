...
HTML;
		...
		echo <<<HTML
<div style="padding-bottom:5px;">{$lang['reply_name']}<br /><input type="text" name="name{$id}" id="name{$id}" class="ui-widget-content ui-corner-all" style="width:350px;" /></div>
<div style="padding-bottom:5px;">{$lang['reply_mail']}<br /><input type="text" name="mail{$id}" id="mail{$id}" class="ui-widget-content ui-corner-all" style="width:350px;" /></div>
HTML;
...
<div><input type="text" name="question_answer{$id}" id="question_answer{$id}" placeholder="{$lang['question_hint']}" class="ui-widget-content ui-corner-all" style="width:70%;" /></div>
HTML;
